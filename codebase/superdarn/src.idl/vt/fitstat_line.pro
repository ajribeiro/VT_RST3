pro fitstat_line
  ...
  for i=0,9 do begin
		loadct,0
		plot,findgen(2),findgen(2),xrange=[0,2000],yrange=[1,10000],pos=[.05,.6,.8,.9],/nodata,/noerase,xticks=20,$
  ...
  for i=0,9 do begin
		loadct,0
		plot,findgen(2),findgen(2),xrange=[0,2000],yrange=[-600,600],pos=[.05,.6,.8,.9],/nodata,/noerase,xticks=20,$
  ...
  for i=0,19 do begin
		loadct,0
		plot,findgen(2),findgen(2),xrange=[.01,.1],yrange=[0,1],pos=[.05,.6,.8,.9],/nodata,/noerase,$
	...
	for i=0,19 do begin
		loadct,0
		plot,findgen(2),findgen(2),xrange=[.01,.1],yrange=[0,3],pos=[.05,.6,.8,.9],/nodata,/noerase,$
										yticks=3,xstyle=1,ystyle=1,charthick=3.,charsize=.9,xtitle="simulated t_d",xticks=9,$
	...
	for i=0,19 do begin
		loadct,0
		plot,findgen(2),findgen(2),xrange=[.01,.1],yrange=[.25,.5],pos=[.05,.6,.8,.9],/nodata,/noerase,$
	...
	for i=0,9 do begin
		loadct,0
		plot,findgen(2),findgen(2),xrange=[0,2000],yrange=[.25,.5],pos=[.05,.6,.8,.9],/nodata,/noerase,xticks=20,$
