PRO web_acflm,date,hr,mn,rad,beam,time
  ...
  filename= '/data/fit/aj/acflm/temp_files/'
...
;     print,'gunzip -f '+ filename+'.out'
    ...
    spawn,"/rst/bin/test_lmfit -new -hr "+hr+" -min "+mn+" -beam "+beam+' /data/raw/2000.amp10000.rawacf'+' > /rst/output_files/'+time+'.lmfit.test'
