...
/*
 (c) 2011 JHU/APL & Others - Please Consult LICENSE.superdarn-rst.3.3.txt for more information.
...
double TimeYMDHMSToJulian(int yr,int mo,int dy,int hr,int mt,double sc) {
  ...
  dfrac=1+(TimeYMDHMSToYrsec(yr+1,mo,dy,hr,mt,sc)+(sc-floor(sc)))/DAY_SEC;
